<?php
 class BancoDados{
    ...
    private static $user     = "id239674_toor";
    private static $password = "toortoor";
    private static $db       = "id239674_cronogramabd";

    /*Método construtor do banco de dados*/

    public function __construct( $bd ){
        if( $bd == 1 ){
            self::$user     = "id239674_noiseless";
            self::$password = "qwertyuiop";
            self::$db       = "id239674_noiselessbd";
        } else {
            self::$user     = "id239674_toor";
            self::$password = "toortoor";
            self::$db       = "id239674_cronogramabd";
        }
    }
    ...
    public function connect(){
        ...
        catch (PDOException $i)
        {
            ...
            echo "ERROR AO CONECTAR AO SERVIDOR";
        }
